...
export const skillGroups = [
  ...
  { title: "Tools", items: ["Git", "SQL", "TypeScript", "System Design basics"] },
  { title: "Working on", items: ["Advanced DSA", "System Design", "Backend"] },
  { title: "Also use", items: ["React", "Python (pandas)", "Vite", "Vercel"] },
];
...
export const principles = [
  ...
  { title: "Finish the job", body: "If it is not used by real people, it is not done." },
];
